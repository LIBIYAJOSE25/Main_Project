                        ...
                        <div class="block-content block-content-full">
                            ...
                            <table class="table table-bordered table-striped table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    $rs=mysqli_query($con, "select order_tbl.login_id,order_tbl.id,order_tbl.status,tbl_cart.price,tbl_cart.location,tbl_cart.quantity,food.name from tbl_cart,order_tbl,food where order_tbl.login_id=tbl_cart.loginid and tbl_cart.fid=food.fid and order_tbl.status='Delivered';");
