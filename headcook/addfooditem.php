...
$sql="insert into food(name,Description,category,file,price,quantity,status) values('$name','$Description','$category','$file','$price','$quantity','active')";
$result = mysqli_query($con,$sql);
echo "<script> alert('Item Added'); window.location.href='addfooditem.php';</script>";
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Add Food Items</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Add Food Items</h3>
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                 <input type="text" class="form-control" name="name" id="name" placeholder="Enter Food Name" value="" required >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-8" for="register1-password">Food Category:</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit"  name="submit" class="btn btn-alt-success">
                                                    <i class="fa fa-plus mr-5"></i> Add Food
                                                </button>
                                            </div>
                                        </div>
                                    </form>
