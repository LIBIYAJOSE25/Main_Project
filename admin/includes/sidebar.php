                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
								...
								<li>
                                    <a  href="viewuserqueries.php"><i class="si si-people"></i><span class="sidebar-mini-hide">Total Users</span></a>
                                 
                                </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-people"></i><span class="sidebar-mini-hide"></span>Stock</a>
                                    <ul>
									
                                        <li>
                                            <a href="addheadcook.php">Add Stock</a>
                                        </li>
                                        <li>
                                            <a href="viewheadcook.php">View Stock</a>
                                        </li>
                                    </ul>
                                </li>
								<li>
                                            <a class="nav-submenu"  href="addpackage.php"><i class="si si-people"></i><span class="sidebar-mini-hide"></span>Add Package</a>
                                        </li>
								<li>
                                            <a class="nav-submenu"  href="viewpackage.php"><i class="si si-people"></i><span class="sidebar-mini-hide"></span>View Package</a>
                                        </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-people"></i><span class="sidebar-mini-hide">Architect</span></a>
                                    <ul>
                                        <li>
                                            <a href="addarchitect.php">Add Architect</a>
                                        </li>
                                        <li>
                                            <a href="viewarchitect.php">View Architect</a>
                                        </li>
                                       
                                    </ul>
                                </li>
								<li>
                                    <a  href="addservice.php"><i class="fa fa-film"></i><span class="sidebar-mini-hide">Add Service</span></a>
                                 
                                </li>
								<li>
                                    <a  href="viewservice.php"><i class="fa fa-film"></i><span class="sidebar-mini-hide">View Service</span></a>
                                 
                                </li>
								<li>
                                    <a  href="runningshow.php"><i class="fa fa-film"></i><span class="sidebar-mini-hide">Running Sevices</span></a>
                                 
                                </li>
								<!--<li>
                                    <a  href="adddrinks.php"><i class="fa fa-glass"></i><span class="sidebar-mini-hide">Add Drinks</span></a>
                                 
                                </li>
								<li>
                                    <a  href="viewdrinks.php"><i class="fa fa-glass"></i><span class="sidebar-mini-hide">View Drinks</span></a>
