        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">View painter</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">View painter</h3>
                        </div>
...
$sql3="select * from painter WHERE status=1";
...
{?>
	 ...
	 <td><img src="../uploads/<?php echo $r['idproof'];?>" width="100" height="100"></td>
	  <td><img src="../uploads/<?php echo $r['file'];?>" width="100" height="100"></td>
                ...
                <td><a style="color:red" href="deletepainter.php?id=<?php echo $r['loginid'];?>"><b>Delete</a></td></tr>
                      <?php
}
?>
