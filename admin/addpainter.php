          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Add Painters</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Add Painters</h3>
...
if ($uname!="")
            {
            echo "<script>alert('please enter another username'); window.location.href='addpainter.php';</script>";
            }
            else
{

            $sq = "INSERT INTO login (email,password,type1,status) VALUES ('$email','$password','painter','1')";
            mysqli_query($con, $sq);
            $sqll = "SELECT * FROM login WHERE email = '$email' and password = '$password' and type1 = 'painter'";
            ...
            $loid=$row['loginid'];
            $sql = "INSERT INTO painter(loginid,name,age,gender,phonenumber,email,idproof,file,status)values('$loid','$name','$age','$gender','$phonenumber','$email','$file','$file1','1')";
            mysqli_query($con, $sql);
            echo "<script> alert('painter Added'); window.location.href='addpainter.php';</script>";
            }
        }
