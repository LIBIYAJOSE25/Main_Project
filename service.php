	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5 col-md-5 col-sm-5 nav-w3ls1">
				<div class="logo">
					<a href="index.html" class="logo-w3ls"><h1>Color My World</h1></a>
				</div>
			</div>
...
<section class="service-w3ls">
	<h3 class="text-center w3layouts w3 w3l w3ls agileits-w3layouts agile w3-agile">Our Services</h3>
	<p class="text-center w3layouts w3 w3l w3ls agileits-w3layouts agile w3-agile">.</p>	
	<div class="container">	
        <!-- Service Panels -->
        <div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">
				<div class="thumbnail">
					<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
						<a href="#set-5" class="hi-icon hi-icon-mobile"></a>
					</div>
					<h4 class="text-center">Interior Painting</h4>
					<p class="serv-p1">Interior paints are paints used in the interior of the building, in areas such as rooms, hallways, offices, bathrooms and kitchens. </p>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">	
				<div class="thumbnail">
					<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
						<a href="#set-5" class="hi-icon hi-icon-star"></a>
					</div>
					<h4 class="text-center">Exterior Painting</h4>
					<p class="serv-p1">Be sure to work your way from top to bottom in a smooth, controlled manner, overlapping each stroke by 8 inches.</p>
				</div>
			</div>
			<!--<div <!--class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">	
				<div class="thumbnail">
					...
					<p class="serv-p1">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">	
				<div class="thumbnail">
...
<section class="service-image">
	<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="images/image2.jpg" alt="w3layouts" title="w3layouts">
            </div>
        </div>
        <!-- /.row -->
	</div>
...
<section class="footer">
	<div class="container">
		...
		<hr>
		<div class="row">
			<div class="col-lg-7 col-md-7 copy-w3ls1">
				<ul class="nav-links">
			...
			<div class="col-lg-5 col-md-5 copy-w3ls2">
