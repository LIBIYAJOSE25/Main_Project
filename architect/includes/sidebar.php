                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                <li class="open">
                                    <a href="waiter.php"><i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboards</span></a>
								...
								<li>
                                    <a  href="viewfoodorderitem.php"><i class="fa fa-food"></i><span class="sidebar-mini-hide">View Orders</span></a>
