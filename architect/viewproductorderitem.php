        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">View Product Order</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">View Product Order</h3>
                        </div>
                        <div class="block-content block-content-full">
                            ...
                            <table class="table table-bordered table-striped table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    $rs=mysqli_query($con, "select order_tbl.login_id,order_tbl.status,order_tbl.id,tbl_cart.price,tbl_cart.location,tbl_cart.quantity,product.name from tbl_cart,order_tbl,product where order_tbl.login_id=tbl_cart.loginid and tbl_cart.fid=product.pid and order_tbl.status='Assigned';");
