...
$sql="insert into product(name,Description,category,file,price,quantity,status) values('$name','$Description','$category','$file','$price','$quantity','active')";
$result = mysqli_query($con,$sql);
echo "<script> alert('Item Added'); window.location.href='addproductitem.php';</script>";
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Add Product Items</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Add Product Items</h3>
