<?php      
   ...
   // $officer_password = $_POST['password'];
        ...
        `pid`='$pid',`name`='$name',`Description`='$Description' where pid='$pid'");
    
            header('location: viewproductitem.php');
     }
...
<form method='post' action="" enctype="multipart/form-data">  
  ...
  <div class="container">  
  <center>  <h1>UPDATE PRODUCT ITEMS</h1> </center>  
  <hr>  
  <div class="modal-header">
            ...
            <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="s">Update</button>
					 <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-right: 66%"><a href="viewproductitem.php">Cancel</a></button>
            </div>
