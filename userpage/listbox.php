...
while($row=mysqli_fetch_array($sql)){
  ...
  $sid = $_GET['pid'];
  $sql = mysqli_query($con,"SELECT * from product where product.pid='$sid'");
...
<form method="post"  enctype="multipart/form-data" action="cart_action.php?pid=<?php echo $sid  ?>">
...
<!--<div class="form-group quantity-box" style="width:200px">
    <label class="control-label" style="margin-left:720px">Color&nbsp:</b></label>
    <input class="form-control" name="color" value="0" min="300" max="450" type="number" style="margin-left:720px">
 </div>
