...
if($_SESSION['id']==""){
  ...
  $sid = $_GET['seid'];
  $sql = mysqli_query($con,"SELECT * from service where service.seid='$sid'");
...
<form method="post"  enctype="multipart/form-data" action="serviceaction.php?seid=<?php echo $sid  ?>">
<img src="<?php echo $imageurl; ?> " width="550px" style="border-radius:70px;margin-right:200px;margin-top:100px" >	
<h2 style="margin-left:720px;margin-top:-500px;font-weight:bold;font-size:30px"><?php echo $sname  ?> </h2>	


<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Description:</b>&nbsp<?php echo $description ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Start Time:</b>&nbsp<?php echo $stime ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">End Time:</b>&nbsp<?php echo $etime ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Charge Per Day:</b>&nbsp<?php echo $pprice ?></h4><br>
<div class="form-group quantity-box" style="width:100px">
    <label class="control-label" style="margin-left:720px">Days&nbsp:</label>
    <input class="form-control" name="seats" value="1" min="1" max="50" type="number" style="margin-left:720px">
 </div>

<input type="submit" name="service" value="Book service" style="height: 50px;color: #fff;  background: #146eb4; width: 200px;font-size: initial;font-weight: 900;margin-left:720px;margin-top:100px">
