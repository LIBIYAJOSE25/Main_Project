                                        ...
                                        <form method="post"  enctype="multipart/form-data" action="">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/<?php echo $raw['image']; ?>" class="img-fluid" alt="Image" style="height: 188px;">
                                                   
                                                </div>
                                                <div class="">
                                                    <h1 style="color: red;" align="center"><?php echo $raw['sname']; ?></h1>
                                                    
                                                
                                                    <a class="nav-link" id="<?php echo $raw['seid']; ?>" href="servicelistboooking.php?seid=<?php echo $raw['seid']; ?>" role="tab" aria-controls="<?php echo $raw['seid']; ?>" aria-selected="true" align="center">Book Service</a>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
