                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                         <div class="card text-white bg-success o-hidden h-100">
                             <div class="card-body">
                                 ...
                                 <div class="mr-5">Book Online Service</div>
                             </div>
                             <a class="card-footer text-white clearfix small z-1" href="usr-book-service.php">
                                 <span class="float-left">View Details</span>
                                 <span class="float-right">
                                     <i class="fas fa-angle-right"></i>
                                 </span>
                ...
                ?>
                                     <tr>
                                       ...
                                       <!--  <td><?php echo $row->v_pass_no;?></td>
                                         ...
                                         <td><?php if($row->status == "Available"){ echo '<span class = "badge badge-success">'.$row->status.'</span>'; } else { echo '<span class = "badge badge-danger">'.$row->status.'</span>';}?></td>
