...
$cartid = $_POST['id'];
$sqlls = "DELETE from booking_tbl where id=$cartid";
mysqli_query($con,$sqlls);
echo"<script>alert('service is Removed');</script>";
...
if(isset($_POST['order'])){
    $total=$_POST['total'];
	$car2 = mysqli_query($con,"SELECT * FROM `booking_tbl` where login_id=$uid");
			            ...
			            <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<img class="img-fluid" src="images/<?php echo $raw['image']; ?>" alt="" />
                                    ...
                                    <td class="quantity-box">
                                        <input type="number" name="days" size="4" value="<?php echo $raw['days']; ?>" min="1" class="c-input-text qty text">
                                    </td>
                                    <td class="total-pr">
