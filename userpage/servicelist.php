...
<h3 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Description:</b>&nbsp<?php echo $description ?></h3><br>
<h3 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Start Time:</b>&nbsp<?php echo $stime ?></h3><br>
<h3 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">End Time:</b>&nbsp<?php echo $etime ?></h3><br>
<button style="height: 50px;margin-left:720px;color: #fff;  background: #146eb4; width: 200px;font-size: initial;font-weight: 900;"><a class="nav-link" id="<?php echo $raw['seid']; ?>" href="servicelist.php?seid=<?php echo $raw['seid']; ?>" role="tab" aria-controls="<?php echo $raw['seid']; ?>" aria-selected="true" align="center">Book Service</a></button>
