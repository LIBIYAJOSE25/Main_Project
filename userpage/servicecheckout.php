...
$sql = mysqli_query($con,"SELECT * from booking_tbl where loginid='$uid'");
			...
			<div class="row">
                ...
                $result = mysqli_query($con,"SELECT * FROM register where loginid='$uid'");
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="odr-box">
                                <div class="title-left">
                                    <h2><b>Service Booking</b></h2>
                                </div>
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                    <?php
                                $result = mysqli_query($con,"SELECT booking_tbl.id,booking_tbl.price,booking_tbl.days,booking_tbl.totalprice, booking_tbl.seid,service.sname, service.image FROM booking_tbl LEFT JOIN service ON booking_tbl.seid = service.seid where loginid='$uid'");
                                while ($raw = mysqli_fetch_array($result)){ ?>
                                        <div class="media-body"> <a href="cart.php"> <b><?php echo $raw['name']; ?></b></a>

                                            <div class="large text-muted">Price: <?php echo $raw['price']; ?> <span class="mx-2"><br></span>Days Booked: <?php echo $raw['seats']; ?> <br> Subtotal: <?php echo $raw['totalprice']; ?> </div>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                <div class="title-left">
                                    <h3><b>Service Booking</b></h3>
                                </div>
                                <div class="d-flex">
                                    <div class="font-weight-bold"><b>Booking</b></div>
                                ...
                                <div class="d-flex gr-total">
                                    ...
                                    <?php
                                    $qq = mysqli_query($con,"SELECT SUM(totalprice) FROM `booking_tbl` WHERE loginid='$uid'");
                        ...
                        <button style="color:#d65106;"><a href="servicebookaction.php?cid=<?php echo $cartid; ?>&&price=<?php echo $price ; ?>" class="ml-auto btn hvr-hover">Book Service</a></button>
                    </div>
                </div>
            </div>
